      ...
      <div className="mx-auto max-w-6xl px-2 sm:px-4">
        ...
        <div className="py-6 md:py-8"> {/* Reduced padding */}
          ...
          <div className="pb-6 text-center md:pb-8"> {/* Reduced padding */}
            <h1
              className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,#3a6e6d,#3a6e6d,#3a6e6d)] bg-[length:200%_auto] bg-clip-text pb-4 font-nacelle text-3xl font-semibold text-transparent md:text-9xl"
              data-aos="fade-up"
            >
              DFB
            </h1>
